...
$resultTotal = mysqli_query($conn, "SELECT id FROM produk");
...
$query = "SELECT * FROM produk ORDER BY id DESC LIMIT $awalData, $jumlahDataPerHalaman";
...
<head>
    ...
    <style>
        ...
        .img-produk { width: 50px; height: 50px; object-fit: cover; border-radius: 8px; border: 1px solid #ddd; }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm py-3">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php">📦 MY INVENTORY</a>
    ...
    <div class="container mt-5 mb-5">
        ...
        <h3 class="fw-bold text-secondary mb-4">Daftar Stok Barang</h3>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php if(mysqli_num_rows($result) > 0) : ?>
                            ...
                            <?php $gambar = !empty($row['gambar_url']) ? $row['gambar_url'] : 'https://via.placeholder.com/60'; ?>
                            <tr>
